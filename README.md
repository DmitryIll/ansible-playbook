# Домашнее задание к занятию 2 «Работа с Playbook» - Илларионов Дмитрий
...
Я предполагаю что через модуль yum нельзя ставить пакеты rpm которые скачены просто так? Но, как исправить?
Например если deb пкет - то нужно стаить dpkg а в centos как? и через ансибл как?
Или нужно скачивать не пакеты а архивы и самому распаковывать и ставить?
